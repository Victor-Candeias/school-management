...
import AddYearForm from "@/components/layout/forms/AddYearForm"; // Import the form component for adding a new school year
    ...
    return (
        <ProtectedRoute>
            ...
            <div className={styles.main_container}>
                <AddYearForm schoolId={schoolId} /> {/* Render the AddSchoolYear form component with the schoolId */}
            </div>
        </ProtectedRoute>
    );
}
